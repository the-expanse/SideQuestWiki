...
You can get a zip from `Beastsaber.com` or `beatsaver.com` , in your PC browser as long as you are on the same Wi-Fi connection type your Quests IP (Found top elft of SideQuest when connected" followed by `:500000` 
